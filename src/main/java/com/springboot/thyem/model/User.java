...
public class User {
	...
	@Size(min = 1, max = 15, message = "name cant be null")
	...
	@NotEmpty(message = " invalid no")
	@Size(min = 10, max = 10, message = "name cant be null")
	private String phone_no;
	@NotEmpty(message = "name cant be null")
	@Size(min = 5, max = 30, message = "name cant be null")
	...
	@Size(min = 1, message = "name cant be null")
	private String dob;
	@NotEmpty(message = "languages cant be null")
